...
students = ['Andrew Xiong','Arthur Gritsyuk','Brandon Balinado','Connor Craig','Jesse Quach','Karen Xue', 'Lauren Prather','Miles Brown','Raul Arambula','Steven Ho','Tyler Colaizzi','Vadym Kharchenko','LJ Matias']
professor = ['Gary Kane']
course = ['CSC 131']
